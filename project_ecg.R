...
# transform  matlab code to R code to simulate P wave.This is the first step. Then other waves (qrs,t) could be simulated and added together 
# to create a complete ECG wave.It is more flexible, since we could set and control some important variables of ECG wave, such as heart beat,
#wave peak,interval, duration. 

# variables: 2l=heartbeat/60s, ampitude = a_pwav, b=(2*l)/d_pwave, =x+t_pwav(p_r interval)

#### step1: p wave
p_wave<-function(x)
{ l=1# half heartbeat cycle.eg.60 heartbeat/60sec=1 cycle
